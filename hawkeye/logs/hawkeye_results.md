...
| False Positive Rate (per min) | 7.96 | — |  |
| Latency (ms/frame) | 8.85 | 10.94 |  (▼ -2.09✓) |
| Inference FPS | 113.1 | 91.4 |  (▲ +21.6✓) |
...
**Inference Speed:** HAWKEYE runs at 113.1 fps vs YOLOFINETUNE's 91.4 fps. The PatchCore nearest-neighbour search accounts for the additional latency (~15-30ms). PRIME addresses this with a fixed-size CNN classifier.
