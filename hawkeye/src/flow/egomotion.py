    ...
    def compute_expected_flow(
        ...
        Args:
            frame_height: actual frame height in pixels (after ROI crop).
                          Defaults to self.frame_height (1080 if raft config absent).
            frame_width:  actual frame width in pixels.
                          Defaults to self.frame_width (1920 if raft config absent).
        ...
        """
        h = frame_height if frame_height is not None else self.frame_height
        w = frame_width  if frame_width  is not None else self.frame_width
